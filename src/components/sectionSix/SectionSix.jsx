...
const SectionSix = () => {
  ...
  return (
    <div className="swiper-container pt-[100px] px-[130px] flex flex-col items-center font-sf-pro">
      <div className="flex justify-between items-center w-full">
        <div>
          <p className="text-[16px] leading-[24px]">You already know?</p>
      ...
      <div className="flex flex-wrap justify-center gap-[20px] mt-4">
        {swiper.slice(currentIndex, currentIndex + cardsPerPage).map((item, index) => (
          <div
            key={index}
            className="relative w-[380px] h-[424px] p-[8px] rounded-[12px_0_0_0] shadow-[0px_4px_28px_-2px_rgba(0,0,0,0.08)]"
          >
            <div className="bg-white h-full rounded-lg flex flex-col">
              <img src={item.img} alt={item.title} className="w-full object-cover rounded-[12px] pb-[20px]" />
              <div className="bg-[#00A7E7] text-[#FDFDFD] text-[14px] text-center rounded-[28px] h-[25px] w-[35%] py-[2px] mx-[8px]">Pet Knowledge</div>
